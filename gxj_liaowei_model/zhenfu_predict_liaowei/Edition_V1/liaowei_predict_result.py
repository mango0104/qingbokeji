...
class Prediction:
    def __init__(self, liaowei_limit_upper=32, liaowei_limit_lower=25, time_span=1, jinjiao_time_data=tjjh_time_mysql(), 
        ...
        self.jinjiao_time_data = jinjiao_time_data
    ...
    def predict(self, Initial_liaowei, start_time, time_length, zhenfu_time_list):
        result, total_deviation, liaowei_list = liaowei_predict(self.liaowei_limit_upper, self.liaowei_limit_lower, self.time_span, 
                                 self.slope, self.intercept, self.jinjiao_time_data, 
    ...
    def predict_result(self, parameter:list):
        ...
        # zhenfu_time_list = [(31, 0.5), (30, 1), (29, 0.5), (28, 1), (30 ,2), (31, 3)]
        ...
        # 进行预测
        result, total_deviation, liaowei_list = self.predict(Initial_liaowei, start_time, time_length, zhenfu_time_list)
        # print(f"预测结果: {result}")
